...
- **Repository state**: pre-implementation, iteration 0 approved 2026-04-17. Beyond this research report, the repo contains [`../README.md`](../README.md) (public landing page), [`../CLAUDE.md`](../CLAUDE.md) (Claude Code working notes), [`strategy/launch-plan.md`](strategy/launch-plan.md) (operational launch plan with the lean iteration ladder, iteration-0 day-by-day checklist, SME reviewer specification, and decisions log D1–D4), [`../LICENSE`](../LICENSE) (MIT), and `.gitignore`. The repo is public at [github.com/qodeca/athloneval](https://github.com/qodeca/athloneval). See `CLAUDE.md` for session guidance and `strategy/launch-plan.md` for the current operational scope – this research report is the *why*, the launch plan is the *what-next*.
