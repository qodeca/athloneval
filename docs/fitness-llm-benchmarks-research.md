...
**Purpose**: Inform the design of `fitbench` by mapping what exists, what's being worked on, and where the gaps are.
...
4. **Nutrition benchmarks are 1–2 years ahead** of fitness (NutriBench, FoodSky, RD exam). fitbench should borrow their playbook: large public datasets, domain-specialised models, real-world deployment follow-ups. See Part I §3.1.
5. **"When LLMs Can't Help"** (arXiv:2511.20652) is the cautionary tale – intrinsic-benchmark wins didn't transfer to real nutrition deployments. fitbench must plan for Stage-3 longitudinal validation. See Part I §3.1.
